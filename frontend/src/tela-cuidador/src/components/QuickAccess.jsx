    ...
    <div className="quick-access-section">
      ...
      <div className="quick-access-grid">
        ...
        <Link to="/atualizar-dados" className="quick-access-button">
          ...
          <span>Atualizar dados do idoso</span>
        </Link>

        <Link to="/medicamentos" className="quick-access-button">
          <svg
            className="quick-access-icon"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <Link to="/relatorios" className="quick-access-button">
          <svg
            className="quick-access-icon"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <Link to="/calendario" className="quick-access-button">
          <svg
            className="quick-access-icon"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
